...
import 'package:archive/pages/Reservation.dart';
import 'package:archive/pages/followup.dart';
    ...
    return Row(
      children: [
        Text(
          TimeH.toString(),
          style:
              TextStyle(fontSize: 25, color: Color.fromARGB(255, 73, 74, 74)),
        ),
        Text(
          ":",
